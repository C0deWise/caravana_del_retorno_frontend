...
export default function SidebarToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center p-4 pl-8 border-b-2 border-secondary rounded-xl justify-start text-primary hover:bg-gray-100 rounded-t-xl transition-colors" // ← justify-start
    >
