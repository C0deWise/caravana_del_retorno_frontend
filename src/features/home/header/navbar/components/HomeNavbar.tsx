...
export default function HomeNavbar() {
  ...
  return (
    <nav
      className="flex h-full justify-evenly items-center text-3xl font-semibold text-(--color-text-inverse) md:text-xl md:px-5 md:gap-4 flex-wrap md:flex-nowrap md:min-w-0"
